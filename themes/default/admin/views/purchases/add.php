                                ...
                                <div class="controls table-controls">
                                    <table id="poTable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-4"><?= lang('stock') ?></th>
                                            <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="poption" class="col-sm-4 control-label">Variante de Producto</label>
                        <div class="col-sm-8">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="pcost" class="col-sm-4 control-label">Costo</label>
                        <div class="col-sm-8">
