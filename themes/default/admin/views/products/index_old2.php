...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            {column_number: 7, filter_default_label: "[<?=lang('car_brand');?>]", filter_type: "text", data: []},
            <?php $col = 7;
            if($Owner || $Admin) {
