        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown hidden-xs"><a class="btn tip" title="Nueva Venta" data-placement="bottom" style="background-color: red;" href="<?= admin_url('sales/add') ?>"><i class="fa fa-star"></i></a></li>
                    <?php if (SHOP) { ?>
                    <?php } ?>
                    <?php if ($Owner) { ?>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($this->session->userdata('ml_accesstoken')): ?>
                    <li>
                            <a class="btn blightOrange tip" id="sync_ml" title="<span><?= lang('sync_ml') ?></span>"
                                data-placement="bottom" data-html="true" href="<?= admin_url('products/syncML') ?>">
                                <i class="fa fa-shopping-cart"></i>
                            </a>
                    </li>
                    <?php else: ?>
                        <li>
                            <a class="btn blightOrange tip" id="signin_ml" title="<span><?= lang('signin_ml') ?></span>"
                                data-placement="bottom" data-html="true" href="http://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=<?= $this->Settings->ml_id ?>&redirect_uri=<?= $this->Settings->ml_redirecturi ?>">
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_add">
                                     ...
                                     <!-- CREADO POR KENDRY -->
                                    <?php if ($this->session->userdata('ml_accesstoken')): ?>
                                    <li id="products_add_ml">
                                            <a class="submenu" href="<?= admin_url('products/add'); ?>?meli=enabled">
                                            <i class="fa fa-plus-circle"></i>
                                            <span class="text"> <?= lang('add_product_ml'); ?></span>
                                            </a>
                                    </li>
                                    <?php endif; ?>
                                    <!-- FIN KENDRY -->
