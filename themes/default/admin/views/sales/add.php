...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php } else { ?>
            localStorage.setItem('slcustomer', '5');
        <?php } ?>
        <?php if ($Owner || $Admin) { ?>
        if (!localStorage.getItem('sldate')) {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12" id="sticker">
                            ...
                            <?php echo form_submit('add_sale', 'Cerrar Compra', 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
                                ...
                                <div class="controls table-controls">
                                    <table id="slTable" class="table items table-striped table-bordered table-condensed table-hover sortable_table">
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <th class="col-md-1"><?= lang("quantity_stock") ?></th>
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_sale', 'Cerrar Compra', 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
                                <button type="button" class="btn btn-danger" id="reset">Reiniciar Compra</button></div>
                        </div>
                    </div>
                </div>
                <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                    <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                        <tr class="warning">
                            ...
                            <td><?= lang('grand_total') ?> <span class="totals_val pull-right" id="gtotal" style="color: #ff0000;">0.00</span></td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="pquantity" class="col-sm-4 control-label"><?= lang('quantity') ?>asdas</label>
