...
class Sales_model extends CI_Model
{
    ...
    public function getProductNames($term, $warehouse_id, $pos = false, $limit = 5)
    {
        ...
        $this->db->select('products.*, products.quantity AS quantity_real, FWP.quantity as quantity, categories.id as category_id, categories.name as category_name', FALSE)
    ...
    public function getAllInvoiceItems($sale_id, $return_id = NULL)
    {
        ...
        $this->db->select('sale_items.*, tax_rates.code as tax_code, tax_rates.name as tax_name, tax_rates.rate as tax_rate, products.image, products.details as details, product_variants.name as variant, products.hsn_code as hsn_code, products.second_name as second_name, products.brand, products.cf1, categories.name AS category')
